...
public class StrategyChooserHelper {
    ...
    //TODO: this must be change to an spring like approach @Component... @Autowire List<Strategies>
    // That would do basically the same, list all available strategies, and help choose the right one.
    public static void setStepppingDirectionStrategy(GameConfig.SteppingDirection direction, GameEngine engine) {
